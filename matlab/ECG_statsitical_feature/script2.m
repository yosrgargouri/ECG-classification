...
trainPred=trainedModel.predictFcn (dataTrain(:,1:5));
...
plotconfusion(tdummyEtat,tdummytrainPred,'Confusion Chart for Train')

%Viisulize the Testing Accuracy
testPred=trainedModel.predictFcn (dataTest(:,1:5));
...
plotconfusion(tdummyTestData,tdummytestPred ,'Confusion Chart for Test')
